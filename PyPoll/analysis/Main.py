...
# calculate each percentage
    kahn_percentage = khan_totalvotes / total_votes
    correy_percentage = correy_totalvotes / total_votes
    li_percentage = li_totalvotes / total_votes
    otooley_percentage = otooley_totalvotes / total_votes
    
    # identify the winner
    winner = max(khan_totalvotes, correy_totalvotes, li_toatlvotes, otooley_totalvotes)
...
output_file = os.path.join('.', 'PyPoll', 'Resources', 'election_data_2.text')
